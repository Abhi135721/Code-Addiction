...
public class Abhi {
	public static void main(String [] args){
		...
		//x will contain the rank of string in all possible strings formed by permutations of its characters
		int x = findRank(st);
	}
    ...
    public int findRank(String A) {
        ...
        rank = ((((min_rank(A.charAt(0) , A) % 1000003 )  * (fact(A.length() - 1) % 1000003)) % 1000003 ) % 1000003 + (findRank(A.substring(1,A.length()))) % 1000003 ) % 1000003; 
        return rank;
